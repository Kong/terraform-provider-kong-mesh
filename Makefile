...
generate-plan-modifiers:
	...
	| sed 's/Resource$$//' \
	| xargs -n1 -I{} sh -c '\
		go run github.com/Kong/shared-speakeasy/generators/resource_plan_modifier@v0.0.2 \
		internal/provider/$$(echo {} | tr A-Z a-z)resource_plan_modify.go {} terraform-provider-kong-mesh'
