...
page_title: "kong-mesh_mesh_rate_limit Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshRateLimit Resource
---

# kong-mesh_mesh_rate_limit (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_rate_limit.my_kong-mesh_mesh_rate_limit
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_rate_limit.my_kong-mesh_mesh_rate_limit '{"mesh": "...", "name": "..."}'
```
