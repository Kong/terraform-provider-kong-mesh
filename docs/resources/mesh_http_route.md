...
page_title: "kong-mesh_mesh_http_route Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshHTTPRoute Resource
---

# kong-mesh_mesh_http_route (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_http_route.my_kong-mesh_mesh_http_route
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_http_route.my_kong-mesh_mesh_http_route '{"mesh": "...", "name": "..."}'
```
