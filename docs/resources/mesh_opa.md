...
page_title: "kong-mesh_mesh_opa Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshOPA Resource
---

# kong-mesh_mesh_opa (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_opa.my_kong-mesh_mesh_opa
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_opa.my_kong-mesh_mesh_opa '{"mesh": "...", "name": "..."}'
```
