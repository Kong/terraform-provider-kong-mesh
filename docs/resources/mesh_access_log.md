...
page_title: "kong-mesh_mesh_access_log Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshAccessLog Resource
---

# kong-mesh_mesh_access_log (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_access_log.my_kong-mesh_mesh_access_log
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_access_log.my_kong-mesh_mesh_access_log '{"mesh": "...", "name": "..."}'
```
