...
page_title: "kong-mesh_mesh_external_service Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshExternalService Resource
---

# kong-mesh_mesh_external_service (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_external_service.my_kong-mesh_mesh_external_service
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_external_service.my_kong-mesh_mesh_external_service '{"mesh": "...", "name": "..."}'
```
