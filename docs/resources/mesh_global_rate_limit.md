...
page_title: "kong-mesh_mesh_global_rate_limit Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshGlobalRateLimit Resource
---

# kong-mesh_mesh_global_rate_limit (Resource)
...
```terraform
resource "kong-mesh_mesh_global_rate_limit" "my_meshglobalratelimit" {
  labels = {
    key = "value"
  }
  mesh = "...my_mesh..."
...
```terraform
import {
  to = kong-mesh_mesh_global_rate_limit.my_kong-mesh_mesh_global_rate_limit
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
