...
page_title: "kong-mesh_mesh_circuit_breaker Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshCircuitBreaker Resource
---

# kong-mesh_mesh_circuit_breaker (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_circuit_breaker.my_kong-mesh_mesh_circuit_breaker
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_circuit_breaker.my_kong-mesh_mesh_circuit_breaker '{"mesh": "...", "name": "..."}'
```
