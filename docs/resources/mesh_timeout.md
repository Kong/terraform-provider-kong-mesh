...
page_title: "kong-mesh_mesh_timeout Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshTimeout Resource
---

# kong-mesh_mesh_timeout (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_timeout.my_kong-mesh_mesh_timeout
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_timeout.my_kong-mesh_mesh_timeout '{"mesh": "...", "name": "..."}'
```
