...
page_title: "kong-mesh_mesh_proxy_patch Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshProxyPatch Resource
---

# kong-mesh_mesh_proxy_patch (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_proxy_patch.my_kong-mesh_mesh_proxy_patch
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_proxy_patch.my_kong-mesh_mesh_proxy_patch '{"mesh": "...", "name": "..."}'
```
