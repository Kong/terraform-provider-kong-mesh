...
page_title: "kong-mesh_mesh_health_check Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshHealthCheck Resource
---

# kong-mesh_mesh_health_check (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_health_check.my_kong-mesh_mesh_health_check
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_health_check.my_kong-mesh_mesh_health_check '{"mesh": "...", "name": "..."}'
```
