...
page_title: "kong-mesh_mesh_open_telemetry_backend Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshOpenTelemetryBackend Resource
---

# kong-mesh_mesh_open_telemetry_backend (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_open_telemetry_backend.my_kong-mesh_mesh_open_telemetry_backend
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_open_telemetry_backend.my_kong-mesh_mesh_open_telemetry_backend '{"mesh": "...", "name": "..."}'
```
