...
page_title: "kong-mesh_mesh_tcp_route Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshTCPRoute Resource
---

# kong-mesh_mesh_tcp_route (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_tcp_route.my_kong-mesh_mesh_tcp_route
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_tcp_route.my_kong-mesh_mesh_tcp_route '{"mesh": "...", "name": "..."}'
```
