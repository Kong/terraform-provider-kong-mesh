...
page_title: "kong-mesh_mesh_load_balancing_strategy Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshLoadBalancingStrategy Resource
---

# kong-mesh_mesh_load_balancing_strategy (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_load_balancing_strategy.my_kong-mesh_mesh_load_balancing_strategy
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_load_balancing_strategy.my_kong-mesh_mesh_load_balancing_strategy '{"mesh": "...", "name": "..."}'
```
