...
page_title: "kong-mesh_mesh_passthrough Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshPassthrough Resource
---

# kong-mesh_mesh_passthrough (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_passthrough.my_kong-mesh_mesh_passthrough
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_passthrough.my_kong-mesh_mesh_passthrough '{"mesh": "...", "name": "..."}'
```
