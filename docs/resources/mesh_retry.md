...
page_title: "kong-mesh_mesh_retry Resource - terraform-provider-kong-mesh"
subcategory: ""
description: |-
  MeshRetry Resource
---

# kong-mesh_mesh_retry (Resource)
...
```terraform
import {
  to = kong-mesh_mesh_retry.my_kong-mesh_mesh_retry
  id = jsonencode({
    mesh = "..."
    name = "..."
  })
...
```shell
terraform import kong-mesh_mesh_retry.my_kong-mesh_mesh_retry '{"mesh": "...", "name": "..."}'
```
