...
func newMeshTimeout(rootSDK *KongMesh, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MeshTimeout {
	return &MeshTimeout{
		rootSDK:          rootSDK,
...
func (s *MeshTimeout) GetMeshTimeout(ctx context.Context, request operations.GetMeshTimeoutRequest, opts ...operations.Option) (*operations.GetMeshTimeoutResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/meshes/{mesh}/meshtimeouts/{name}", request, nil)
	if err != nil {
...
// PutMeshTimeout - Creates or Updates MeshTimeout entity
func (s *MeshTimeout) PutMeshTimeout(ctx context.Context, request operations.PutMeshTimeoutRequest, opts ...operations.Option) (*operations.PutMeshTimeoutResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.PutMeshTimeoutResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
