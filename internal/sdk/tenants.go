...
// CreateTenant - Create a VCP
// Creates a tenant
func (s *Tenants) CreateTenant(ctx context.Context, request *shared.ProvisionMeshControlPlaneRequest, opts ...operations.Option) (*operations.CreateTenantResponse, error) {
