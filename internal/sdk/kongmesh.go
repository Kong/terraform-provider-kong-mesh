...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.731.4
...
func New(opts ...SDKOption) *KongMesh {
	sdk := &KongMesh{
		SDKVersion: "0.6.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.6.2 2.731.4 2.0.0 github.com/kong/terraform-provider-kong-mesh/internal/sdk",
