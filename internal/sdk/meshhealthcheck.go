...
func newMeshHealthCheck(rootSDK *KongMesh, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MeshHealthCheck {
...
func (s *MeshHealthCheck) GetMeshHealthCheck(ctx context.Context, request operations.GetMeshHealthCheckRequest, opts ...operations.Option) (*operations.GetMeshHealthCheckResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/meshes/{mesh}/meshhealthchecks/{name}", request, nil)
	if err != nil {
...
func (s *MeshHealthCheck) PutMeshHealthCheck(ctx context.Context, request operations.PutMeshHealthCheckRequest, opts ...operations.Option) (*operations.PutMeshHealthCheckResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	res := &operations.PutMeshHealthCheckResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *MeshHealthCheck) GetMeshHealthCheckList(ctx context.Context, request operations.GetMeshHealthCheckListRequest, opts ...operations.Option) (*operations.GetMeshHealthCheckListResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/meshes/{mesh}/meshhealthchecks", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
