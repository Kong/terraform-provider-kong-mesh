...
// MeshMultiZoneServiceItemStatusHostnameGeneratorsStatus - status of the condition, one of True, False, Unknown.
type MeshMultiZoneServiceItemStatusHostnameGeneratorsStatus string

const (
	MeshMultiZoneServiceItemStatusHostnameGeneratorsStatusTrue    MeshMultiZoneServiceItemStatusHostnameGeneratorsStatus = "True"
	MeshMultiZoneServiceItemStatusHostnameGeneratorsStatusFalse   MeshMultiZoneServiceItemStatusHostnameGeneratorsStatus = "False"
	MeshMultiZoneServiceItemStatusHostnameGeneratorsStatusUnknown MeshMultiZoneServiceItemStatusHostnameGeneratorsStatus = "Unknown"
)
...
type MeshMultiZoneServiceItemStatusConditions struct {
	...
	Reason string `json:"reason"`
	// status of the condition, one of True, False, Unknown.
	Status MeshMultiZoneServiceItemStatusHostnameGeneratorsStatus `json:"status"`
	// type of condition in CamelCase or in foo.example.com/CamelCase.
	Type string `json:"type"`
}

func (m *MeshMultiZoneServiceItemStatusConditions) GetMessage() string {
	if m == nil {
		return ""
	}
	return m.Message
...
func (m *MeshMultiZoneServiceItemStatusConditions) GetReason() string {
	if m == nil {
		return ""
	}
	return m.Reason
...
func (m *MeshMultiZoneServiceItemStatusConditions) GetStatus() MeshMultiZoneServiceItemStatusHostnameGeneratorsStatus {
	if m == nil {
		return MeshMultiZoneServiceItemStatusHostnameGeneratorsStatus("")
	}
	return m.Status
}

func (m *MeshMultiZoneServiceItemStatusConditions) GetType() string {
	if m == nil {
		return ""
	}
	return m.Type
...
type MeshMultiZoneServiceItemHostnameGenerators struct {
	...
	Conditions           []MeshMultiZoneServiceItemStatusConditions         `json:"conditions,omitempty"`
	HostnameGeneratorRef MeshMultiZoneServiceItemStatusHostnameGeneratorRef `json:"hostnameGeneratorRef"`
}

func (m *MeshMultiZoneServiceItemHostnameGenerators) GetConditions() []MeshMultiZoneServiceItemStatusConditions {
	if m == nil {
		return nil
	}
	return m.Conditions
...
func (m *MeshMultiZoneServiceItemStatus) GetConditions() []MeshMultiZoneServiceItemConditions {
	if m == nil {
		return nil
	}
	return m.Conditions
...
// MeshMultiZoneServiceItemInput - MeshMultiZoneService provides global load balancing and service discovery across multiple zones in a multi-zone mesh deployment. It aggregates MeshServices from different zones by label selectors, creating a unified service endpoint with automatic VIP assignment and hostname generation for cross-zone communication and failover.
// MeshMultizoneServices are only created on global
