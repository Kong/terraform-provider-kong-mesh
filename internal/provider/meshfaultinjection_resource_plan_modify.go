...
func (r *MeshFaultInjectionResource) ModifyPlan(
	...
	var plannedResource MeshFaultInjectionResourceModel
	...
	res, err := r.client.MeshFaultInjection.GetMeshFaultInjection(ctx, operations.GetMeshFaultInjectionRequest{
