...
var _ resource.ResourceWithModifyPlan = &MeshTCPRouteResource{}

func (r *MeshTCPRouteResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshTCPRouteResourceModel
	...
	res, err := r.client.MeshTCPRoute.GetMeshTCPRoute(ctx, operations.GetMeshTCPRouteRequest{
