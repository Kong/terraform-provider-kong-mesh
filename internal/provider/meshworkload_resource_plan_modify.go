...
var _ resource.ResourceWithModifyPlan = &MeshWorkloadResource{}

func (r *MeshWorkloadResource) ModifyPlan(
	ctx context.Context,
	...
	request := operations.GetWorkloadRequest{
