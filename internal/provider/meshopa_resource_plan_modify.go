...
var _ resource.ResourceWithModifyPlan = &MeshOPAResource{}

func (r *MeshOPAResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshOPAResourceModel
	...
	res, err := r.client.MeshOPA.GetMeshOPA(ctx, operations.GetMeshOPARequest{
