...
var _ resource.ResourceWithModifyPlan = &MeshAccessAuditResource{}

func (r *MeshAccessAuditResource) ModifyPlan(
	ctx context.Context,
	...
	request := operations.GetAccessAuditRequest{
	...
	if res.StatusCode != http.StatusNotFound {
		resp.Diagnostics.AddError(
			"MeshAccessAudit already exists",
