...
var _ resource.ResourceWithModifyPlan = &MeshAccessLogResource{}

func (r *MeshAccessLogResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshAccessLogResourceModel
	...
	res, err := r.client.MeshAccessLog.GetMeshAccessLog(ctx, operations.GetMeshAccessLogRequest{
