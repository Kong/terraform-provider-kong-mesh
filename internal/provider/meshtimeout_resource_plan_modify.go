...
var _ resource.ResourceWithModifyPlan = &MeshTimeoutResource{}

func (r *MeshTimeoutResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshTimeoutResourceModel
	...
	res, err := r.client.MeshTimeout.GetMeshTimeout(ctx, operations.GetMeshTimeoutRequest{
