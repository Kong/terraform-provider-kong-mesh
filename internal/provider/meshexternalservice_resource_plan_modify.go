...
var _ resource.ResourceWithModifyPlan = &MeshExternalServiceResource{}

func (r *MeshExternalServiceResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshExternalServiceResourceModel
	...
	res, err := r.client.MeshExternalService.GetMeshExternalService(ctx, operations.GetMeshExternalServiceRequest{
	...
	if res.StatusCode != http.StatusNotFound {
		resp.Diagnostics.AddError(
			"MeshExternalService already exists",
