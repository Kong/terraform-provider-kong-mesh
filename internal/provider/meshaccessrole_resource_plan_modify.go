...
var _ resource.ResourceWithModifyPlan = &MeshAccessRoleResource{}

func (r *MeshAccessRoleResource) ModifyPlan(
	ctx context.Context,
	...
	request := operations.GetAccessRoleRequest{
