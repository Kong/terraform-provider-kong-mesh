...
var _ resource.ResourceWithModifyPlan = &MeshLoadBalancingStrategyResource{}

func (r *MeshLoadBalancingStrategyResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshLoadBalancingStrategyResourceModel
	...
	res, err := r.client.MeshLoadBalancingStrategy.GetMeshLoadBalancingStrategy(ctx, operations.GetMeshLoadBalancingStrategyRequest{
	...
	if res.StatusCode != http.StatusNotFound {
		resp.Diagnostics.AddError(
			"MeshLoadBalancingStrategy already exists",
