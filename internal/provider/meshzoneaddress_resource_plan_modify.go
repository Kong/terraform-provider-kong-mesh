...
var _ resource.ResourceWithModifyPlan = &MeshZoneAddressResource{}

func (r *MeshZoneAddressResource) ModifyPlan(
	ctx context.Context,
	...
	request := operations.GetMeshZoneAddressRequest{
		Name: name.ValueString(),
	}
	request.Mesh = mesh.ValueString()
	res, err := r.client.MeshZoneAddress.GetMeshZoneAddress(ctx, request)
	...
	if res.StatusCode != http.StatusNotFound {
		resp.Diagnostics.AddError(
			"MeshZoneAddress already exists",
