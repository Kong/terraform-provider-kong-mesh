...
var _ resource.ResourceWithModifyPlan = &MeshRetryResource{}

func (r *MeshRetryResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshRetryResourceModel
