...
var _ resource.ResourceWithModifyPlan = &MeshHTTPRouteResource{}

func (r *MeshHTTPRouteResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshHTTPRouteResourceModel
	...
	res, err := r.client.MeshHTTPRoute.GetMeshHTTPRoute(ctx, operations.GetMeshHTTPRouteRequest{
