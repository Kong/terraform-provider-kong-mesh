...
var _ resource.ResourceWithModifyPlan = &MeshOpenTelemetryBackendResource{}

func (r *MeshOpenTelemetryBackendResource) ModifyPlan(
	ctx context.Context,
	...
	request := operations.GetMeshOpenTelemetryBackendRequest{
	...
	if res.StatusCode != http.StatusNotFound {
		resp.Diagnostics.AddError(
			"MeshOpenTelemetryBackend already exists",
