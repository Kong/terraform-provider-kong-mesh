...
var _ resource.ResourceWithModifyPlan = &MeshTraceResource{}

func (r *MeshTraceResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshTraceResourceModel
	...
	res, err := r.client.MeshTrace.GetMeshTrace(ctx, operations.GetMeshTraceRequest{
