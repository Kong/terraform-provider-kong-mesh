...
var _ datasource.DataSource = &MeshAccessLogListDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshAccessLogListDataSource{}

func NewMeshAccessLogListDataSource() datasource.DataSource {
	return &MeshAccessLogListDataSource{}
}
...
func (r *MeshAccessLogListDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_access_log_list"
}

// Schema defines the schema for the data source.
func (r *MeshAccessLogListDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshAccessLogList DataSource",
...
func (r *MeshAccessLogListDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshAccessLogListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshAccessLogListDataSourceModel
	...
	request, requestDiags := data.ToOperationsGetMeshAccessLogListRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.MeshAccessLog.GetMeshAccessLogList(ctx, *request)
	if err != nil {
	...
	if !(res.MeshAccessLogList != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedMeshAccessLogList(ctx, res.MeshAccessLogList)...)
