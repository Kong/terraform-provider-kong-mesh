...
var _ resource.ResourceWithModifyPlan = &MeshMetricResource{}

func (r *MeshMetricResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshMetricResourceModel
	...
	res, err := r.client.MeshMetric.GetMeshMetric(ctx, operations.GetMeshMetricRequest{
