...
var _ resource.ResourceWithModifyPlan = &MeshMultiZoneServiceResource{}

func (r *MeshMultiZoneServiceResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshMultiZoneServiceResourceModel
	...
	res, err := r.client.MeshMultiZoneService.GetMeshMultiZoneService(ctx, operations.GetMeshMultiZoneServiceRequest{
	...
	if res.StatusCode != http.StatusNotFound {
		resp.Diagnostics.AddError(
			"MeshMultiZoneService already exists",
