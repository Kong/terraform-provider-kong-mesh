...
var _ resource.ResourceWithModifyPlan = &MeshServiceResource{}

func (r *MeshServiceResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshServiceResourceModel
	...
	res, err := r.client.MeshService.GetMeshService(ctx, operations.GetMeshServiceRequest{
