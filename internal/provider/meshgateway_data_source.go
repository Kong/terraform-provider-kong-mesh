...
var _ datasource.DataSource = &MeshGatewayDataSource{}
var _ datasource.DataSourceWithConfigure = &MeshGatewayDataSource{}

func NewMeshGatewayDataSource() datasource.DataSource {
	return &MeshGatewayDataSource{}
}

// MeshGatewayDataSource is the data source implementation.
type MeshGatewayDataSource struct {
	client *sdk.KongMesh
}
...
func (r *MeshGatewayDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_mesh_gateway"
}

// Schema defines the schema for the data source.
func (r *MeshGatewayDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "MeshGateway DataSource",
...
func (r *MeshGatewayDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *MeshGatewayDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *MeshGatewayDataSourceModel
