...
var _ resource.ResourceWithModifyPlan = &MeshHealthCheckResource{}

func (r *MeshHealthCheckResource) ModifyPlan(
	ctx context.Context,
	...
	var plannedResource MeshHealthCheckResourceModel
	...
	res, err := r.client.MeshHealthCheck.GetMeshHealthCheck(ctx, operations.GetMeshHealthCheckRequest{
	...
	if res.StatusCode != http.StatusNotFound {
		resp.Diagnostics.AddError(
			"MeshHealthCheck already exists",
