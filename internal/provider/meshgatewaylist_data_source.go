...
func (r *MeshGatewayListDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	request, requestDiags := data.ToOperationsGetMeshGatewayListRequest(ctx)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedMeshGatewayList(ctx, res.MeshGatewayList)...)
